...
!      Call HX(N,No,N2,Max1,Max2,Nstr,Ex1,Ex2,X,h,V,XH)
      ...
      Subroutine Hred(N,No,N2,Max1,Max2,Nstr,X1,X2,X3,X4,h,V,H1s)
      Use FCIUtils
      Implicit None
      ...
      Real*8 X1H(Nstr,Nstr),X2H(Nstr,Nstr),X3H(Nstr,Nstr),X4H(Nstr,Nstr)
      Real*8 H1s(4,4)

      Call IString(N,No,N2,Max1,Max2,Ex1,Ex2)
!     Compute Matrix Elements      
      Call UHX(N,No,N2,Max1,Max2,Nstr,Ex1,Ex2,X1,h,h, 
     $  V,V,V,X1H)
      Call UHX(N,No,N2,Max1,Max2,Nstr,Ex1,Ex2,X2,h,h, 
     $  V,V,V,X2H)
      Call UHX(N,No,N2,Max1,Max2,Nstr,Ex1,Ex2,X3,h,h, 
     $  V,V,V,X3H)
      Call UHX(N,No,N2,Max1,Max2,Nstr,Ex1,Ex2,X4,h,h, 
     $  V,V,V,X4H)

      H1s(1,1) = MDot(X1,X1H); H1s(1,2) = MDot(X1,X2H)
      H1s(1,3) = MDot(X1,X3H); H1s(1,4) = MDot(X1,X4H)
      H1s(2,1) = MDot(X2,X1H); H1s(2,2) = MDot(X2,X2H)
      H1s(2,3) = MDot(X2,X3H); H1s(2,4) = MDot(X2,X4H)
      H1s(3,1) = MDot(X3,X1H); H1s(3,2) = MDot(X3,X2H)
      H1s(3,3) = MDot(X3,X3H); H1s(3,4) = MDot(X3,X4H)
      H1s(4,1) = MDot(X4,X1H); H1s(4,2) = MDot(X4,X2H)
      H1s(4,3) = MDot(X4,X3H); H1s(4,4) = MDot(X4,X4H)

!      H1s(1,1) = MDot(X1,X1); H1s(1,2) = MDot(X1,X2)
!      H1s(1,3) = MDot(X1,X3); H1s(1,4) = MDot(X1,X4)
!      H1s(2,1) = MDot(X2,X1); H1s(2,2) = MDot(X2,X2)
!      H1s(2,3) = MDot(X2,X3); H1s(2,4) = MDot(X2,X4)
!      H1s(3,1) = MDot(X3,X1); H1s(3,2) = MDot(X3,X2)
!      H1s(3,3) = MDot(X3,X3); H1s(3,4) = MDot(X3,X4)
!      H1s(4,1) = MDot(X4,X1); H1s(4,2) = MDot(X4,X2)
!      H1s(4,3) = MDot(X4,X3); H1s(4,4) = MDot(X4,X4)
!      H1s(1,1) = X1(1,1); H1s(1,2) = X1(1,2)
!      H1s(1,3) = X1(2,1); H1s(1,4) = X1(2,2)
!      H1s(2,1) =          H1s(2,2)
!      H1s(2,3) =          H1s(2,4)
!      H1s(3,1) =          H1s(3,2)
!      H1s(3,3) =          H1s(3,4)
