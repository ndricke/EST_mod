...
def fiboSph(radius=1.,cen=[0.,0.,0.],samples=1000):#,randomize=True):
##I think this would make some of the coordinates a little random, but it doesn't seem necessary
    rnd = 1. #phi needs this to be defined; I'm leaving it in just in case random is nec. later
#    if randomize:
